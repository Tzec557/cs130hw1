...
As the quarter goes by, we will be adding files and functionality to it.  The
file "code-intro.pdf" will guide you through this portion of homework 1.
...
The directory "tests-hw2" contains the test cases that will be completed as part
of homework 2. They are included as part of homework 1 so that you can become
familiarized with the full workflow of building, running individual tests, and
running the grading script .  You will get a new directory of test cases each
time we add new features to the code (the next batch of test cases will be in a
directory called "tests-hw4"). For example, the first test case is
"tests-hw2/00.txt". The solution for this test case is "tests-hw2/00.png". The
main.cpp file contains detailed instructions on how to run the program on test
cases.  Although the test cases are intended to be completed in order, you may
work on them out of order if you prefer.


GRADING SCRIPT

You are given the grading script that will be used to grade the coding part of
the assignment. You can run it like this: "./grading-script.py tests-hw2" This
tells the grading script to grade the test cases in the directory "tests-hw2",
which is the test cases for this assignment. In homework 4, you will run
"./grading-script.py tests-hw4" instead. It is important that you are able to
run the grading script. It is a good idea to run this frequently. Students
generally run it every time they finish a test case to see which test to work on
next.
